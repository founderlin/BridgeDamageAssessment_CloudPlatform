...
Public Module SofistikDataTypes
    ...
    Structure CSECT_REC          ' 9/NR:10  SectiontypeRectangular T-Beam
        ...
        Dim m_ASBM As Single        ' [1022] Minimum shear reinf.
    ...
    Public Structure CNODE              ' 20/00  Nodes
    ...
    Structure CCABL_RES          ' 162/LC:+  results of cables
        ...
        Dim m_F0 As Single          '        vertical suspension of cable in load direction
        Dim m_L0 As Single          '        relaxed cable length incl. temp. and prestrain effects
        Dim m_LEX As Single         '        nonlinear effect
        <MarshalAs(UnmanagedType.ByValArray, SizeConst:=6)> Dim m_DAMM() As Single '        Damage Parameter
    End Structure
    ...
    Structure CQUAD_RTS          ' 230/LC  tendon stresses in two integration points
        ...
        Dim m_ZZ As Single          ' [1025] force in tendon
        Dim m_ZH As Single          ' [1025] duct deduction force
        Dim m_SZG1 As Single        ' [1092] stress in G-point 1
        Dim m_SZG2 As Single        ' [1092] stress in G-point 2
        Dim m_ZZX1 As Single        ' [1025] force tendon+cement1
        Dim m_ZZX2 As Single        ' [1025] force tendon+cement1
        Dim m_ZHG1 As Single        ' [1025] duct deduction G1
        Dim m_ZHG2 As Single        ' [1025] duct deduction G2
        Dim m_ZZG1 As Single        ' [1025] force in tendon G1
        Dim m_ZZG2 As Single        ' [1025] force in tendon G2
